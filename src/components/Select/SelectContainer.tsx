...
export default function SelectContainer() {
  ...
  return (
    <div className="flex gap-[1.6rem]">
      ...
      >
        <Listbox.Button id='mainCategory' className="flex min-h-[4.2rem] min-w-[24rem] justify-between rounded border border-[#474E57] bg-neutral-navy-950 px-[2rem] py-[0.9rem] text-[1.4rem] focus:border-neutral-navy-200">
