        ...
        <TableContainer>
          ...
          <TableItem title="판매가격" required={true}>
            <div className="flex w-[19.6rem]">
              <TextInput type="number" required={true} width={24} placeholder="숫자만 입력" />
          ...
          <TableItem title="썸네일 이미지" required={true}>
            <ImageUploader  required={true} width={21.4} height={26.6} id={1} />
            <p className="pt-[2rem]">
          ...
          <TableItem title="상세 페이지 이미지" required={false}>
            <div className="flex flex-col gap-[2.6rem]">
              <div className="imageContainer flex gap-[2.6rem]">
                <ImageUploader required={false} width={21.4} height={15.8} id={2} />
                <ImageUploader required={false} width={21.4} height={15.8} id={3} />
                <ImageUploader required={false} width={21.4} height={15.8} id={4} />
                <ImageUploader required={false} width={21.4} height={15.8} id={4} />
                <ImageUploader required={false} width={21.4} height={15.8} id={5} />
              </div>
              <p>
