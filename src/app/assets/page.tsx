          ...
          <TableItem title='검색어' required={false} >
            <div className='flex gap-[6.4rem]'>
              <label htmlFor="assetId">
                ...
                <input type="text" id='assetId' className='rounded border border-[#474E57] bg-neutral-navy-950 px-[2rem] py-[0.9rem] text-[1.4rem]'/>
              </label>
              <label htmlFor="assetName">
                <span className='pr-[1.6rem] text-[1.4rem]'>상품명</span>
                <input type="text" id='assetName' className='rounded border border-[#474E57] bg-neutral-navy-950 px-[2rem] py-[0.9rem] text-[1.4rem]'/>
              </label>
            </div>
            <div></div>
          </TableItem>
